...
services:
  kafka-to-influxdb-ew-0:
    ...
    environment:
      ...
      CONF_KAFKA_FILTER_CLIENT_CONSUMER_GROUP_ID: 'kafka-to-influxdb-ew-0'
  ...
  kafka-to-influxdb-ew-1:
    ...
    environment:
      ...
      CONF_KAFKA_DATA_CLIENT_CONSUMER_GROUP_ID: 
      CONF_KAFKA_DATA_CLIENT_SUBSCRIBE_INTERVAL: 
      CONF_KAFKA_FILTER_CLIENT_CONSUMER_GROUP_ID: 'kafka-to-influxdb-ew-1'
      CONF_KAFKA_FILTER_CLIENT_FILTER_TOPIC: 
      CONF_KAFKA_FILTER_CLIENT_POLL_TIMEOUT: 
      CONF_KAFKA_FILTER_CLIENT_SYNC_DELAY: 
      CONF_KAFKA_FILTER_CLIENT_TIME_FORMAT: 
        ...
        - name: export-worker
          ...
          env:
            ...
            - name: CONF_KAFKA_CONSUMER_GROUP_ID_POSTFIX
              value: 
            - name: CONF_KAFKA_DATA_CLIENT_CONSUMER_GROUP_ID
              value: 
            - name: CONF_KAFKA_DATA_CLIENT_SUBSCRIBE_INTERVAL
              value: 
            - name: CONF_KAFKA_FILTER_CLIENT_CONSUMER_GROUP_ID
              valueFrom:
                fieldRef:
